...
extend(DecentralandVesting.prototype, {
...
extend(LANDRegistry.prototype, {
  ...
  isOperatorAuthorizedFor: function(operator, assetHolder, ...args) {
    return this.call('isOperatorAuthorizedFor', operator, assetHolder, ...args)
  },
  ...
  authorizeOperator: function(operator, authorized, ...args) {
    return this.transaction('authorizeOperator', operator, authorized, ...args)
  },
  ...
  assignMultipleParcels: function(x, y, beneficiary, ...args) {
    return this.transaction('assignMultipleParcels', x, y, beneficiary, ...args)
  },
...
extend(TerraformReserve.prototype, {
  ...
  changeContractState: function(_acceptingDeposits, ...args) {
    return this.transaction('changeContractState', _acceptingDeposits, ...args)
  },
