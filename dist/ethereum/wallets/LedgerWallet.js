...
var LedgerWallet = exports.LedgerWallet = function (_Wallet) {
  ...
  function LedgerWallet(account, derivationPath) {
    ...
    _this.ledger = null;
    _this.engine = null;
    _this.derivationPath = derivationPath || LedgerWallet.derivationPath;
    return _this;
  }
  ...
  _createClass(LedgerWallet, [{
    key: 'connect',
    value: function () {
      var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(providerUrl, networkId) {
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 7:
                ...
                _context2.next = 11;
                return this.getProvider(providerUrl, networkId);
    ...
    value: function disconnect() {
      _get(LedgerWallet.prototype.__proto__ || Object.getPrototypeOf(LedgerWallet.prototype), 'disconnect', this).call(this);
        ...
        return regeneratorRuntime.wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                _context3.next = 2;
                return (0, _ledgerWalletProvider2.default)(function () {
                  return networkId;
                }, this.derivationPath);
              ...
              case 2:
                ...
                return _context3.abrupt('return', this.engine);
