...
var eth = exports.eth = {
  ...
  connectWallet: function () {
    var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(defaultAccount) {
      var providerUrl = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : '';
      var derivationPath = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : null;
      var wallet, networks, network;
          ...
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              network = networks.find(function (network) {
                return providerUrl.includes(network.name);
              }) || networks[0];


              wallet = new _wallets.LedgerWallet(defaultAccount, derivationPath);
              _context2.next = 7;
              return wallet.connect(providerUrl, network.id);
