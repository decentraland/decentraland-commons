  ...
  _createClass(LANDRegistry, [{
    ...
    value: function decodeLandData() {
      ...
      switch (version) {
        ...
        default:
          throw new DataError('Unknown version when trying to decode land data: "' + data + '" (see https://github.com/decentraland/commons/blob/master/docs/land-data.md)');
      }
    }
  }, {
    key: 'encodeLandData',
    value: function encodeLandData() {
      ...
      switch (data.version.toString()) {
        ...
        default:
          throw new DataError('Unknown version when trying to encode land data: "' + JSON.stringify(data) + '"\n          (see https://github.com/decentraland/commons/blob/master/docs/land-data.md)');
      }
    }
  }, {
    key: 'getContractName',
...
LANDRegistry.DataError = DataError;
...
var DataError = function (_Error) {
  ...
  function DataError(message) {
    ...
    var _this2 = _possibleConstructorReturn(this, (DataError.__proto__ || Object.getPrototypeOf(DataError)).call(this, message));

    _this2.name = 'DataError';
    return _this2;
  }
